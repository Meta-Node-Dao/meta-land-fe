...
export const ShareButtonClass = `rounded-full flex justify-center items-center cursor-pointer bg-[#F0F0F0] h-6 text-center leading-7 w-6 hover:text-primary hover:bg-white hover:shadow`
